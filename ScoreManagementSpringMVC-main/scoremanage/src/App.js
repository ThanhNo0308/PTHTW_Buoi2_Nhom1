...
import OAuth2AdditionalInfo from './components/OAuth2AdditionalInfo';
...
const App = () => {
  ...
  return (
    <GoogleOAuthProvider clientId="355786478653-eada1fahhslucloivggn2nrqlhalacho.apps.googleusercontent.com">
          ...
          <UniqueSubjectTeacherIdProvider>
            <BrowserRouter>
              ...
              <Routes className="routes">
                ...
                <Route path="/oauth2/additional-info" element={<OAuth2AdditionalInfo />} />
