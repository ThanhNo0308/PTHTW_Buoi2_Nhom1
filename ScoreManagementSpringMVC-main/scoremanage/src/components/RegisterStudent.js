...
const RegisterStudent = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.email.endsWith('@dh.edu.vn')) {
      setFieldErrors({
        ...fieldErrors,
        email: "Email phải có định dạng @dh.edu.vn"
      });
      return;
    }
    ...
    try {
      ...
      if (err.response && err.response.data) {
        ...
        else if (errorMessage.includes("Tên đăng nhập đã tồn tại")) {
          setFieldErrors({
            ...fieldErrors,
            username: "Tên đăng nhập đã tồn tại. Vui lòng chọn tên đăng nhập khác."
          });
        }
        else {
          // Các lỗi khác
          setError(errorMessage || "Đăng ký không thành công. Vui lòng thử lại sau.");
        }
      } else {
          ...
          <form onSubmit={handleSubmit}>
            <div className="row">
              <div className="col-md-6">
                ...
                {fieldErrors.avatar && (
                  <div className="text-danger mt-1">{fieldErrors.avatar}</div>
                )}
              </div>
              ...
              <div className="col-md-6">
                ...
                <div className="mb-4">
                  ...
                  {fieldErrors.username && (
                    <div className="text-danger mt-1">{fieldErrors.username}</div>
                  )}
                </div>
