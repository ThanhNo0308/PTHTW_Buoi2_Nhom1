...
public class ApiClassSessionController {
    ...
    public ResponseEntity<?> getStudentSchedule(
        ...
        try {
            ...
            if (schoolYear != null) {
                Map<String, Object> schoolYearInfo = new HashMap<>();
                schoolYearInfo.put("id", schoolYear.getId());
                schoolYearInfo.put("nameYear", schoolYear.getNameYear());
                schoolYearInfo.put("semesterName", schoolYear.getSemesterName());

                if (schoolYear.getYearStart() != null) {
                    schoolYearInfo.put("startDate", schoolYear.getYearStart());
                }
                if (schoolYear.getYearEnd() != null) {
                    schoolYearInfo.put("endDate", schoolYear.getYearEnd());
                }

                response.put("schoolYear", schoolYearInfo);
            }
